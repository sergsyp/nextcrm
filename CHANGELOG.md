...
## [0.21.0](https://github.com/sergsyp/nextcrm/compare/v0.20.2...v0.21.0) (2026-08-03)


### Added

* add Docker entrypoint script for auto-initialization ([1acba0a](https://github.com/sergsyp/nextcrm/commit/1acba0a5311dc99181075e61da92d59b099aff1c))
* add docker-compose.yml with all services ([c045ebb](https://github.com/sergsyp/nextcrm/commit/c045ebbfb0d07c25fa3e5c09c44b4ace7467b067))
...
* add multi-stage Dockerfile for NextCRM ([70a1b45](https://github.com/sergsyp/nextcrm/commit/70a1b45937af818df1a6b1c99f7d774f49af2796))
...
* **crm:** add assign/disconnect document server actions for CRM tasks ([26f234a](https://github.com/sergsyp/nextcrm/commit/26f234a4837014b6ce8d8d3ae2f128367a7ec6c2))
...
* Docker self-hosting setup with full automation ([bff363e](https://github.com/sergsyp/nextcrm/commit/bff363e646f0bfa55178922f4af05234515a0920))
* enable Next.js standalone output for Docker ([d8d1056](https://github.com/sergsyp/nextcrm/commit/d8d10565fb0fbb425f5d9bb2a41c3fe06a24cf83))
...
* **crm:** expand getCrMTask document select and clean up junction on delete ([b6d2f6b](https://github.com/sergsyp/nextcrm/commit/b6d2f6b4197999af116ae2165d80c7feb4cefd42))
...
* **crm:** remove task-specific filters from document table toolbar ([5cca3d1](https://github.com/sergsyp/nextcrm/commit/5cca3d1e4e25caef5b6b09056575495ec77c9a64))
...
* **crm:** switch CRM task document actions from broken axios calls to server actions ([efae73e](https://github.com/sergsyp/nextcrm/commit/efae73e56c78d80fcfa7b1358a3bf78df32e8f43))
* **crm:** uncomment assigned_to_user in task document schema and remove ts-ignore ([46c2868](https://github.com/sergsyp/nextcrm/commit/46c2868b34779d0924f578ae94dc3eb9cd303d7b))
...
* **crm:** wire task comments to correct FK column (assigned_crm_account_task) ([c60ea57](https://github.com/sergsyp/nextcrm/commit/c60ea57dd2f45d800ead11466a32a5696d1c3754))
...
* Docker e2e verification fixes ([e1ae699](https://github.com/sergsyp/nextcrm/commit/e1ae699cf8ce0e767bacdd3034f14bf3b4bf304b))
* **docker:** make admin email configurable via ADMIN_EMAIL ([7427b0a](https://github.com/sergsyp/nextcrm/commit/7427b0a3277b8fff83635cd1cf339eab92d442f1))
...
* **docker:** replace hardcoded credentials with env-driven placeholders ([255b11e](https://github.com/sergsyp/nextcrm/commit/255b11e882d4e6bdcb4172f8905bd65556ee22df))
...
* **crm:** stop routing CRM task comments through the projects module ([2056d4f](https://github.com/sergsyp/nextcrm/commit/2056d4fa34512ea06c28e931ae44c347d6e87b54))
* **crm:** stop routing CRM task documents through the projects module ([aa6512e](https://github.com/sergsyp/nextcrm/commit/aa6512e0aaae3d6d7c7a057a68a1bdec59d85025))
* **crm:** wire account tasks to existing server actions ([fa84440](https://github.com/sergsyp/nextcrm/commit/fa84440493bc7f31564972f92e6bd1d47e58bcc4))
...
* remove axios dependency entirely ([d777bfb](https://github.com/sergsyp/nextcrm/commit/d777bfb8468c1c34aee5464e83ea14034c8c6d91))
