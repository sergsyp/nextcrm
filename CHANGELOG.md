...
## [0.21.0](https://github.com/sergsyp/nextcrm/compare/v0.20.2...v0.21.0) (2026-08-14)


### Added

* add Mailtrap email provider helper ([562aeb9](https://github.com/sergsyp/nextcrm/commit/562aeb947f5f5c2038d29753176fb871562e19a7))
* add Mailtrap sandbox email testing provider ([9dd0a7d](https://github.com/sergsyp/nextcrm/commit/9dd0a7db078334d418576c5eea1ccad04e8758d9))
* add real sending capability to Mailtrap helper ([7229e90](https://github.com/sergsyp/nextcrm/commit/7229e903c494efed6aed4987066da8cbe079a0af))
* **admin:** connect automation trigger kinds to sales stages in CRM settings ([49847ba](https://github.com/sergsyp/nextcrm/commit/49847bab3a41f5617530de09edd4e79ad3193d69))
* **admin:** instance-grade funnel timing settings page ([e94d1da](https://github.com/sergsyp/nextcrm/commit/e94d1da373c2e84b68d72bb6104aea3f39958c2c))
* **admin:** mount Resend service card at /admin/services ([3c552db](https://github.com/sergsyp/nextcrm/commit/3c552dba846415cbaeb267474f56afa95d84cac5))
* **ai-team:** add observable nightly sales pipeline ([eea1a48](https://github.com/sergsyp/nextcrm/commit/eea1a4847068220e08420fc3c614cf4f427d6d56))
* **ai-team:** add recoverable pipeline trigger ([2e947e7](https://github.com/sergsyp/nextcrm/commit/2e947e74da5575b76a2d12e9f26a4eba507bb63f))
* **ai-team:** add Telegram approvals and CRM conversations ([1fc7aca](https://github.com/sergsyp/nextcrm/commit/1fc7aca21326911b624aed28e70a73c420205f00))
* **ai-team:** automate daily sales pipeline ([75ea5bf](https://github.com/sergsyp/nextcrm/commit/75ea5bf280c6d30593c9b0e4029446b437660ddb))
* **ai-team:** autonomous daily sales pipeline ([b9c2027](https://github.com/sergsyp/nextcrm/commit/b9c2027e2cd0fe9037b52051b527113d133fa038))
* AQUNAMA Phase 1 — global email opt-out, target-to-deal conversion, delivery deadline, XLSX import ([f8dacb3](https://github.com/sergsyp/nextcrm/commit/f8dacb3b3ab3e2c6626e8d9019233785d468f792))
* AQUNAMA Phase 2 — funnel timer & task engine (kill rule, cadence, care, recycle, renewals) ([8d2a866](https://github.com/sergsyp/nextcrm/commit/8d2a866c703f950defc6517cd4411cb05de32a25))
* AQUNAMA Phase 3 — SOW/quote approval workflow + case-study flags ([43f95bf](https://github.com/sergsyp/nextcrm/commit/43f95bfdac390298c70751ff462143f4987a312d))
* **authz:** add account read-scope helpers ([6fdff66](https://github.com/sergsyp/nextcrm/commit/6fdff669fdd1db42789b106e0e4f8939a98f6ff0))
* **authz:** add account write-scope assertion helper ([fb4b8f6](https://github.com/sergsyp/nextcrm/commit/fb4b8f66052d62097bea9c66c1d0c8bf9ae4c05c))
* **authz:** add account/lead/opportunity id-filter helpers (similarity post-filter) ([98b32f1](https://github.com/sergsyp/nextcrm/commit/98b32f17eb2c11e9237f95eddc85d0bf89d8206b))
* **authz:** add activity-for-entity scope dispatch helper ([db08f51](https://github.com/sergsyp/nextcrm/commit/db08f51b8b943ffac1a755029a27c352e6ac7a6f))
* **authz:** add AuthenticationError and AuthorizationError ([47e4980](https://github.com/sergsyp/nextcrm/commit/47e49805928975b8a0932c380871c0e174c287c1))
* **authz:** add barrel export ([48a2a5e](https://github.com/sergsyp/nextcrm/commit/48a2a5e379f8a634ebd322603c139c2cf715a399))
* **authz:** add board and task read/write scope helpers ([380e6a5](https://github.com/sergsyp/nextcrm/commit/380e6a59f636416ef1650ef849b947b6edab7a4a))
* **authz:** add bulk-id authorization filters for contacts and targets ([388d29d](https://github.com/sergsyp/nextcrm/commit/388d29dcbea52c6dfcfe2e3720ed2bb3fc515cb7))
* **authz:** add campaign and template read/write scope helpers ([6af7af0](https://github.com/sergsyp/nextcrm/commit/6af7af033f6d49df1844fb07e2687401d110c7c0))
* **authz:** add canonical AppRole type and legacy role mapper ([1350ed3](https://github.com/sergsyp/nextcrm/commit/1350ed39623a61aa31ed2e9220fa66b7782796a4))
* **authz:** add document read/write scope helpers (linked-entity aware) ([f2122a2](https://github.com/sergsyp/nextcrm/commit/f2122a23eec404e431445d7645ef9c3431e5bdce))
* **authz:** add enrichment cancel permission helpers ([6acbfec](https://github.com/sergsyp/nextcrm/commit/6acbfec765d0bc68748a20f8b3df75602220bd5c))
* **authz:** add lead/contact/opportunity/contract read-scope helpers (linked-account aware) ([bfaef87](https://github.com/sergsyp/nextcrm/commit/bfaef8756686eb2c07236b1250e67032cbaafbb4))
* **authz:** add read/write assertion helpers for contacts and targets ([e0fff6b](https://github.com/sergsyp/nextcrm/commit/e0fff6b911f145fe1878de9d3969657b897bb2f9))
* **authz:** add ReportScope builder for per-role report data filtering ([0035bf0](https://github.com/sergsyp/nextcrm/commit/0035bf0cb3047a5a54c7caf7eb898b2037306d79))
* **authz:** add requireAuthenticated, requireRole, role predicates ([30c3472](https://github.com/sergsyp/nextcrm/commit/30c3472f94e6e2555ad2ca9109f793c795b7c497))
* **authz:** add route response helpers (401/403/404) ([7ad29ae](https://github.com/sergsyp/nextcrm/commit/7ad29aea1639d3c403d1283698c65c74aef164ed))
* **authz:** add scoped contact and target update helpers ([071cb2c](https://github.com/sergsyp/nextcrm/commit/071cb2ceab48858c505a3ed7e3b0ae47119e7b1e))
* **authz:** add target and target-list read-scope helpers ([45b82a8](https://github.com/sergsyp/nextcrm/commit/45b82a87538d54921cbb370b9d873cb42cc68a35))
* **authz:** align UI/action callers to canonical role names ([1dc5618](https://github.com/sergsyp/nextcrm/commit/1dc5618c6c17d3e5b96295c9c38ff2324fd91447))
* **authz:** object-level authorization on account write actions ([69edcfe](https://github.com/sergsyp/nextcrm/commit/69edcfea75ec2af1565a54424b93ac17fae72621))
* **authz:** object-level authorization on contact write actions ([c08d61b](https://github.com/sergsyp/nextcrm/commit/c08d61be5782aa452c1516facea8c98ecccc110c))
* **authz:** object-level authorization on contract write actions ([12750da](https://github.com/sergsyp/nextcrm/commit/12750dae561e15add52ef62d0bdfefd55b6288eb))
* **authz:** object-level authorization on CRM task write actions ([8be1abb](https://github.com/sergsyp/nextcrm/commit/8be1abb88516555c8779fdca0cbe4c7adaf15a36))
* **authz:** object-level authorization on lead write actions ([747d9dc](https://github.com/sergsyp/nextcrm/commit/747d9dc3c56ee97fd278758e79f6744a8fd6ebec))
* **authz:** object-level authorization on opportunity write actions ([c0c8379](https://github.com/sergsyp/nextcrm/commit/c0c837913aff65ccaede4deb36c4dc5611c564ff))
* **authz:** object-level authorization on target write actions ([522ac83](https://github.com/sergsyp/nextcrm/commit/522ac832b9bf5b8b4fcf13cbeb12685596e09e53))
* **authz:** object-level authorization on target-list write actions ([a748ef1](https://github.com/sergsyp/nextcrm/commit/a748ef1f124ebde27a5e07aeac0d65b4084d262b))
* **authz:** parent-scoped authorization on contract line-items ([cad5741](https://github.com/sergsyp/nextcrm/commit/cad57416c5cefe2a723adf7c7c74b3b296a101fc))
* **authz:** parent-scoped authorization on opportunity line-items ([a973962](https://github.com/sergsyp/nextcrm/commit/a973962deb106897e591169aa98312fd830cec15))
* **authz:** switch Users.role to Prisma enum AppRole ([d598305](https://github.com/sergsyp/nextcrm/commit/d598305ebc97b15852f41d5cc5f1807836302cfe))
* **authz:** validate setUserRole against canonical AppRole ([77241b7](https://github.com/sergsyp/nextcrm/commit/77241b726b748a5191c5acb6c331888672eac947))
* **authz:** write-scope asserts for lead, opportunity, contract, target-list, crm-task, line-items ([4eead0e](https://github.com/sergsyp/nextcrm/commit/4eead0e6ee22e5112e3dcf548bc7854f02624de9))
* **calendar:** CalendarConnection + crm_CalendarEvents models for Phase 4 sync ([816a5c0](https://github.com/sergsyp/nextcrm/commit/816a5c045f876f456418a0bd28a19fee62a73784))
* **calendar:** Calendly admin settings page + org webhook subscription ([bdede85](https://github.com/sergsyp/nextcrm/commit/bdede854b6e26242f76cdd7ef16312605f293a3e))
* **calendar:** Calendly settings storage + signed webhook endpoint ([f92c728](https://github.com/sergsyp/nextcrm/commit/f92c7283359dae3cdf63f4c7c9050de64fa04131))
* **calendar:** Calendly webhook HMAC signature verification ([42d3142](https://github.com/sergsyp/nextcrm/commit/42d31424c7036187e7edd96741c7a7292306ea92))
* **calendar:** counterparty email matcher (contact &gt; target &gt; lead) ([e942991](https://github.com/sergsyp/nextcrm/commit/e9429917eeb99ac3522dab7d79944bbdf37311b1))
* **calendar:** dedicated Calendar tab on profile + OAuth result banner ([7240889](https://github.com/sergsyp/nextcrm/commit/724088999b2d139d6e09d993624df9c6441aaf94))
* **calendar:** emit outbound sync events from activity writers ([de3c34b](https://github.com/sergsyp/nextcrm/commit/de3c34b5ad903ab654930c7c5982949456737b4d))
* **calendar:** Google Calendar incremental polling sync via Inngest ([f70b663](https://github.com/sergsyp/nextcrm/commit/f70b66320de1b508f6207aa8f760496921cf4898))
* **calendar:** Google Calendar OAuth connect flow (readonly scope) ([2e8b591](https://github.com/sergsyp/nextcrm/commit/2e8b59147bde47a176dee78da272591aecbd4d0d))
* **calendar:** inngest outbound push to Google Calendar with invites ([2f9eeec](https://github.com/sergsyp/nextcrm/commit/2f9eeec3ae577edb586829d95d30bc01b6d03c2c))
* **calendar:** inngest processor for crm/calendar.event.received ([dc96cd1](https://github.com/sergsyp/nextcrm/commit/dc96cd1dcbedfe9a89c4eaf941c910ce330196bd))
* **calendar:** outbound decision, event builder, counterparty resolver ([e0ee516](https://github.com/sergsyp/nextcrm/commit/e0ee51699e97595ce9fa35371df59826f8cdc0f0))
* **calendar:** profile UI for Google Calendar connections ([ea5e7c5](https://github.com/sergsyp/nextcrm/commit/ea5e7c5dc6bfed2ed7be97f7fe2b67ebcb3a1be3))
* **calendar:** register calendar settings in admin sidebar ([7791ab2](https://github.com/sergsyp/nextcrm/commit/7791ab2d6ac62c1111a2ae1a875fdd1533b206d2))
* **calendar:** scopeLevel on CalendarConnection for write-scope upgrade ([9f6b87b](https://github.com/sergsyp/nextcrm/commit/9f6b87b04aca41b7613ad2e6845fce550df32b9f))
* **calendar:** shared idempotent calendar-event processor ([2e4aa70](https://github.com/sergsyp/nextcrm/commit/2e4aa70712cf45400544256bb0fe7a7b1160573d))
* **calendar:** two-way sync upgrade button + scope level in profile UI ([2cf2f1d](https://github.com/sergsyp/nextcrm/commit/2cf2f1d68ef5727bfd22c1213d242b9437012e66))
* **calendar:** write-scope OAuth upgrade with granted-scope detection ([f06f386](https://github.com/sergsyp/nextcrm/commit/f06f3869c8f939eda27204ba25064fa222ff443c))
* **campaigns:** enforce global do_not_email across send pipeline and import ([4471454](https://github.com/sergsyp/nextcrm/commit/44714549f46acbe1f2f03ecc4b8f581180ce4887))
* **campaigns:** unsubscribe sets global do_not_email suppression on targets ([6a97c5b](https://github.com/sergsyp/nextcrm/commit/6a97c5b43da924d4961e6d0648ab154d598f5c82))
* configure autonomous AI CRM team ([e2786a0](https://github.com/sergsyp/nextcrm/commit/e2786a01f51965551e5457731473352d355914e9))
* **crm:** 45-day kill rule cron with inbound-email/activity clock ([aa591a1](https://github.com/sergsyp/nextcrm/commit/aa591a142ccda15e2304ecdbd62c21405cea41fa))
* **crm:** add delivery_deadline field to opportunities (PO-stage requirement) ([fba530b](https://github.com/sergsyp/nextcrm/commit/fba530b9354f2a3dc626300b380a6d00870902b5))
* **crm:** add global do_not_email flag on targets and delivery_deadline on opportunities ([8a7c8a6](https://github.com/sergsyp/nextcrm/commit/8a7c8a6ff525d9f04ad3d9c2ed2ef2e25b62aab6))
* **crm:** approval-status fields on opportunities, case-study flags on accounts ([c69ca5b](https://github.com/sergsyp/nextcrm/commit/c69ca5b8fc475208e94d06815db82412d1f1db83))
* **crm:** approvals queue page and deal-page approval UI ([a726c04](https://github.com/sergsyp/nextcrm/commit/a726c0449986542b678a9d73c4c4ab661da4bc79))
* **crm:** AQUNAMA Phase 4 — calendar sync (Calendly + Google Calendar inbound) ([57fa4ec](https://github.com/sergsyp/nextcrm/commit/57fa4ec4c26b481c06a874db00a8f4f9503bfc93))
* **crm:** auto-task helper and 5-touch qualified follow-up cadence ([366af8a](https://github.com/sergsyp/nextcrm/commit/366af8a7d8debb1acd37d77cbac087ee5a1e4a60))
* **crm:** care touchpoint engine (check-in, referral, quarterly) ([ab9aff8](https://github.com/sergsyp/nextcrm/commit/ab9aff8fc39061dd474a26b16a8488ebdfe3324f))
* **crm:** case-study candidate/approval flags on accounts ([50df4b4](https://github.com/sergsyp/nextcrm/commit/50df4b457956cd1cf46826a89763e0ebd37760a3))
* **crm:** configurable timer logic — business days, cadence/care schedules, kill predicate, settings loader ([cd956fc](https://github.com/sergsyp/nextcrm/commit/cd956fce0934aeb9865ae64496d6c27b0f23c6ce))
* **crm:** convert target to deal with campaign attribution and entry stage ([2d79035](https://github.com/sergsyp/nextcrm/commit/2d79035315263eaae9c1f009c3def7c76f74158b))
* **crm:** emit crm/opportunity.stage-changed from all stage-writing actions ([413bd48](https://github.com/sergsyp/nextcrm/commit/413bd48d558574d297e24f24d0eb0bb8323c577c))
* **crm:** hard-block unapproved deals from entering the qualified stage ([32237bb](https://github.com/sergsyp/nextcrm/commit/32237bb8c9efffb414189e98ebb2c7cc8151699a))
* **crm:** quote approval request/decide actions with notifications ([c68295b](https://github.com/sergsyp/nextcrm/commit/c68295b65fab209f51158c4ff59ea97181931315))
* **crm:** show invoices on account detail page ([a207314](https://github.com/sergsyp/nextcrm/commit/a207314aded4b706b6fca9b537a603cbb55a9972))
* **crm:** show invoices on account detail page ([5f0f4e9](https://github.com/sergsyp/nextcrm/commit/5f0f4e98314cd4bb4efe60e2c7d9967bc09f7d5f))
* **crm:** stage_kind on sales stages, task-opportunity link, stage_entered_at ([8eff98c](https://github.com/sergsyp/nextcrm/commit/8eff98c4ea8b493ff7a3847450498caa3977fbae))
* **crm:** support XLSX target imports via shared spreadsheet parser ([4dabb29](https://github.com/sergsyp/nextcrm/commit/4dabb29b2e0a35a2f150cc45c0dd0e2e96b61180))
* **crm:** target recycle cron with Recycled list and admin digest ([8c83243](https://github.com/sergsyp/nextcrm/commit/8c8324357bd011aae849daab8ec14b8930aeb3c8))
* **crm:** weekly renewal reminder sweep for contracts and account products ([18da8de](https://github.com/sergsyp/nextcrm/commit/18da8de91bac437ca271cf4585aa94da96d4a905))
* **dashboard:** add Invoices, Campaigns, Targets cards; remove Employee card ([df13534](https://github.com/sergsyp/nextcrm/commit/df1353496e128f0f6c7035a28391e9ec8c786b76))
* **db:** backfill canonical roles (admin/manager/user) and sync is_admin ([f7475f5](https://github.com/sergsyp/nextcrm/commit/f7475f5d081a1cba0ae76c9af962c10f5209648b))
* **dev:** Inngest dev server via docker-compose.dev.yml for host development ([7596978](https://github.com/sergsyp/nextcrm/commit/7596978289202d402246f27b47c2e3c15bc786c8))
* **dev:** local pgvector Postgres service for host development ([c28e2d4](https://github.com/sergsyp/nextcrm/commit/c28e2d41394889682b56f8f8210174cfd8375c20))
* **dev:** point DATABASE_URL at local Postgres, add db:migrate ([0e9b69c](https://github.com/sergsyp/nextcrm/commit/0e9b69c1268a1081c98a7dd7c921556bf22e6485))
* **dev:** seed local database, add db:seed and db:reset ([8f4f415](https://github.com/sergsyp/nextcrm/commit/8f4f41520df2350bee74640209d8bac70be85c14))
* **i18n:** translate remaining Russian UI strings ([9df792b](https://github.com/sergsyp/nextcrm/commit/9df792bb31f4aa0221d19b7b5e7abf8ed82ae5fc))
* **invoices:** add FKs, indexes, line-item trigger, money CHECK ([1496266](https://github.com/sergsyp/nextcrm/commit/1496266419db40292f2b0829eacafbc2c9457c4d))
* **invoices:** add numbering format template + counter consumer ([e533aeb](https://github.com/sergsyp/nextcrm/commit/e533aeb4e7bbe55c1b5a4a5e77c8a6872ef2bc6f))
* **invoices:** add PDF i18n string bundles (EN/CZ) ([02bcd7d](https://github.com/sergsyp/nextcrm/commit/02bcd7d04f3ffda004f8b2297038314ea0564dbd))
* **invoices:** add permission guards ([cb12109](https://github.com/sergsyp/nextcrm/commit/cb121093ed0f49895fa079a8158ed02ba74810ef))
* **invoices:** add Prisma schema, migration, tsvector trigger ([6b9f7f3](https://github.com/sergsyp/nextcrm/commit/6b9f7f366e8592a07d0ac534d0cc6b216762379c))
* **invoices:** add search filter builder ([a37c5fb](https://github.com/sergsyp/nextcrm/commit/a37c5fb894101a9f1d30ab91651f3ece0707d109))
* **invoices:** add totals computation with mixed VAT support ([cced002](https://github.com/sergsyp/nextcrm/commit/cced002054d70f3b6ccb26d6fca20d31bcf70584))
* **invoices:** admin pages — tax rates, series, currencies, settings ([9ed05dc](https://github.com/sergsyp/nextcrm/commit/9ed05dc5f6518784e72f697e5ef0595d04eea5b9))
* **invoices:** API routes for invoices CRUD, lifecycle, payments, search, admin config ([dcd47d0](https://github.com/sergsyp/nextcrm/commit/dcd47d09b367006c3fd467d817b7ef98969cc68c))
* **invoices:** fetch FX rates via frankfurter.app ([04c4e0e](https://github.com/sergsyp/nextcrm/commit/04c4e0e208aba5eb5ad849736357fbca4223f708))
* **invoices:** full invoicing module ([2b420ff](https://github.com/sergsyp/nextcrm/commit/2b420ff085211e321572a55e02a400662380fbc7))
* **invoices:** invoice email template ([788252b](https://github.com/sergsyp/nextcrm/commit/788252b5f3e31692f90a965f4132c1147619d8db))
* **invoices:** invoice UI — list, new, detail, edit pages ([40a09a6](https://github.com/sergsyp/nextcrm/commit/40a09a6e3e62da41d9b01bca8cbfab1bf687c4df))
* **invoices:** MinIO storage wrapper for invoice PDFs ([028d4c2](https://github.com/sergsyp/nextcrm/commit/028d4c2ed35b1cc0a945d317263cf76f82d18bc2))
* **invoices:** PDF render entry ([b9112c4](https://github.com/sergsyp/nextcrm/commit/b9112c426ad86b810d28a62a1faf723c4b7271ce))
* **invoices:** PDF template (@react-pdf/renderer) ([11109f6](https://github.com/sergsyp/nextcrm/commit/11109f62c5fdc5754446862b1beffb285a476127))
* **invoices:** seed currencies, default series, tax rates, settings ([68a8b80](https://github.com/sergsyp/nextcrm/commit/68a8b80793a5f989bd5ea031522e8e467d7459c0))
* **invoices:** server actions for invoice lifecycle ([e698e71](https://github.com/sergsyp/nextcrm/commit/e698e716141f4dcd0d48e2bea7a0bb9ec7217e7e))
* **invoices:** sidebar nav entry + i18n (EN/CZ) ([8c5f1d6](https://github.com/sergsyp/nextcrm/commit/8c5f1d609961e870b5823990695f75edbcd6a839))
* **invoices:** Zod schemas + shared types ([103b2c8](https://github.com/sergsyp/nextcrm/commit/103b2c81517ae23eed2e01f7361c0b1d8acc7273))
* let sales agent manage approved email threads ([dcf62b1](https://github.com/sergsyp/nextcrm/commit/dcf62b1fb3fda6e0c30f9af12229aa8bfeebc974))
* **mcp:** add crm_list_users and opportunity reassignment ([d2adc62](https://github.com/sergsyp/nextcrm/commit/d2adc6262086a975369cc71411e81fd166d89490))
* **mcp:** assertScopeOrNotFound adapter for object-level tool authorization ([d9e12d2](https://github.com/sergsyp/nextcrm/commit/d9e12d270a0b01477421d44a335ff52a517ce7b9))
* **mcp:** object-level authorization on project board tools ([df19c69](https://github.com/sergsyp/nextcrm/commit/df19c69fc49a2829dc04baae812a4bfe5a2cde14))
* **mcp:** object-level authorization on project comment + document-link tools ([b8d967c](https://github.com/sergsyp/nextcrm/commit/b8d967cf2bc7b078e289ccb94280a300c3de9d78))
* **mcp:** object-level authorization on project section tools ([a5faf98](https://github.com/sergsyp/nextcrm/commit/a5faf98d8362f10a5f7ae2ca5877ae47bd28ff0e))
* **mcp:** object-level authorization on project task tools; drop userBoardWhere ([f36e85a](https://github.com/sergsyp/nextcrm/commit/f36e85a2dc0f96c8af19bd68cf6818fd440ee462))
* **mcp:** read-scoped authorization on project watch_board (escalation fix) ([7f6d2f8](https://github.com/sergsyp/nextcrm/commit/7f6d2f83a2b1e6f19fc9445cdb4989141ab5e1fb))
* **mcp:** reassignment on accounts, contacts and leads; scope CRM lead tools ([0591426](https://github.com/sergsyp/nextcrm/commit/05914261d7236370237d50edde9d3474d91ea4f3))
* **mcp:** reassignment on accounts, contacts and leads; scope CRM lead tools ([2e7220a](https://github.com/sergsyp/nextcrm/commit/2e7220a50d1b98d668192299a1e42ba90099b1c9))
* **net:** assertPublicHost — resolve-validate-pin guard against SSRF/DNS-rebinding ([e4f8e95](https://github.com/sergsyp/nextcrm/commit/e4f8e954248f2484341c31f5bfc8d0bb9f01ac90))
* **net:** ip-rules — refuse non-public-unicast addresses (SSRF) ([17cbb28](https://github.com/sergsyp/nextcrm/commit/17cbb28de85aa29192b4a66837372a148aaf794c))
* publish approved CRM landing pages ([599c347](https://github.com/sergsyp/nextcrm/commit/599c347c3866114199a51344ca6d4df4e42263a0))
* ready AI team runtime and mailbox delegation ([3a3af68](https://github.com/sergsyp/nextcrm/commit/3a3af6800a7f78f5a0420f1ed83bb2f0894e912d))
* **reports:** per-category functions accept ReportScope to filter data by role ([87d73e0](https://github.com/sergsyp/nextcrm/commit/87d73e0c982b11c259bbdeef298641e087fd4251))
* run autonomous AI team tasks ([9fceb58](https://github.com/sergsyp/nextcrm/commit/9fceb58b974a83f6f035afca83d57e7b1ce00814))
* **security:** permission-driven authorization migration (Phases A → F.1) ([e06478f](https://github.com/sergsyp/nextcrm/commit/e06478ff16f9a7472c6d16cd0ef6e96c5c409446))
* **security:** SSRF host-guard on IMAP test/discover/create sinks ([a775e0d](https://github.com/sergsyp/nextcrm/commit/a775e0d0498362b7240e82b6543cdf25e9c1249e))
* **security:** SSRF host-guard on SMTP send and background IMAP connect ([53eeac4](https://github.com/sergsyp/nextcrm/commit/53eeac43eb4ec9aa3ba57777d88a01504f6c570c))
* send login codes through SMTP ([1248cab](https://github.com/sergsyp/nextcrm/commit/1248cab06c546a11b04a05b06c7b85226870a0fe))
* support configurable SMTP relay port ([cba59a2](https://github.com/sergsyp/nextcrm/commit/cba59a291813071efa720db1f76c95a64540b7b9))
* **telegram:** remind on unresolved approvals ([e3c44cb](https://github.com/sergsyp/nextcrm/commit/e3c44cb39a3f79bd6cfa21f8c926b665053a0aa0))


### Fixed

* **account-products:** require account read scope on get-account-products ([36f2d0d](https://github.com/sergsyp/nextcrm/commit/36f2d0d073adcab04729e15395d1f1b1d0273890))
* **account-products:** require account write scope on assignment mutations ([dfa1850](https://github.com/sergsyp/nextcrm/commit/dfa18506a9d96eacb31c7014ca39d17cf46c1c56))
* **admin:** require admin role on activate/deactivate user (close audit gap) ([8215af2](https://github.com/sergsyp/nextcrm/commit/8215af27d86575b3a094e554dbe4e401810fc5e4))
* **admin:** require admin role on CRM-settings server actions ([be27db7](https://github.com/sergsyp/nextcrm/commit/be27db7b31c6e65796bed7d73d1ba8433173a561))
* **admin:** require admin role on currency server actions ([8dfc9ad](https://github.com/sergsyp/nextcrm/commit/8dfc9ad99c3c5224675f9d11046f014a98c1115c))
* **ai-team:** add public web search fallback ([3d13d87](https://github.com/sergsyp/nextcrm/commit/3d13d871953b6f654001c999aea8a7424f8e36f7))
* **ai-team:** add public web search fallback ([138db3f](https://github.com/sergsyp/nextcrm/commit/138db3ffb406a9406586db0446142c3be99e0ebd))
* **ai-team:** allow sales to read prospect targets ([#16](https://github.com/sergsyp/nextcrm/issues/16)) ([f106362](https://github.com/sergsyp/nextcrm/commit/f106362bac1be657ae267072db125b19ecda248d))
* **ai-team:** attach pipeline tags to created targets ([f253765](https://github.com/sergsyp/nextcrm/commit/f253765eb28fe3daca00bfed964a5deb6bef5738))
* **ai-team:** distinguish missing AI tariffs ([c31dc55](https://github.com/sergsyp/nextcrm/commit/c31dc5584061a1d9f6484349c357f420292703da))
* **ai-team:** guarantee approval task resumption ([3f1b225](https://github.com/sergsyp/nextcrm/commit/3f1b225256a6954a80cda35b7a98008ed67953b5))
* **ai-team:** guarantee approval task resumption ([1e1926c](https://github.com/sergsyp/nextcrm/commit/1e1926c340b287ca9c95469b32b47fd7cb9f60ca))
* **ai-team:** harden email recovery and rate-limit retries ([195d30a](https://github.com/sergsyp/nextcrm/commit/195d30a964444fb88230898df008ccb2803c656e))
* **ai-team:** preserve results from exhausted runs ([6779a2f](https://github.com/sergsyp/nextcrm/commit/6779a2fbd8a4961891102de775aaa14e0ad4f697))
* **ai-team:** recover missing tool entities in-run ([c22f9df](https://github.com/sergsyp/nextcrm/commit/c22f9df15096ef062bde57df6a34a6b495a7d62c))
* **ai-team:** recover nightly prospecting pipeline ([84c7f91](https://github.com/sergsyp/nextcrm/commit/84c7f91a02c9ee6b83be4029d435f68352302d70))
* **ai-team:** recover nightly prospecting pipeline ([#13](https://github.com/sergsyp/nextcrm/issues/13)) ([d633e54](https://github.com/sergsyp/nextcrm/commit/d633e54555e75c771191b09e74b88d623d2aeab7))
* **ai-team:** recover safely from provider rate limits ([5fbd0ac](https://github.com/sergsyp/nextcrm/commit/5fbd0acc233f8491921c106ebb317e195a68a77c))
* **ai-team:** resolve recovered task incidents ([#15](https://github.com/sergsyp/nextcrm/issues/15)) ([f43433b](https://github.com/sergsyp/nextcrm/commit/f43433b64fc0ef95e78b71f582dd70889073a0d4))
* **ai-team:** support configured TypeScript target ([baa45e0](https://github.com/sergsyp/nextcrm/commit/baa45e07f3b9ffdbca9635adcce2f2c18dfb4114))
* **ai-team:** support pipeline stages across sales boards ([f7abbc6](https://github.com/sergsyp/nextcrm/commit/f7abbc65c44da8f51127286b999ece06bf59798a))
* **ai-team:** support pipeline stages across sales boards ([#12](https://github.com/sergsyp/nextcrm/issues/12)) ([b633a46](https://github.com/sergsyp/nextcrm/commit/b633a46691b9bd06e4a8bfbed18cba384c01f4d4))
* **ai-team:** type structured pipeline metadata ([8fed7c5](https://github.com/sergsyp/nextcrm/commit/8fed7c528ec49e4e06f205cc84742be60e535f2b))
* allow assigned tasks to move within shared boards ([7b3769c](https://github.com/sergsyp/nextcrm/commit/7b3769c22fa90238df11e59065d1441ec6b92151))
* **api:** filter contact bulk enrichment ids by user scope ([5014d9a](https://github.com/sergsyp/nextcrm/commit/5014d9ad747c75e0278950a361e30073d09c7c17))
* **api:** filter target bulk enrichment ids by user scope ([4af94fe](https://github.com/sergsyp/nextcrm/commit/4af94fe910f9eb3b0290fe519eae0e7efde1a72e))
* **api:** require contact write scope on enrich POST/DELETE ([b1530c0](https://github.com/sergsyp/nextcrm/commit/b1530c091ebc15e255ccce47e220b755bae8db17))
* **api:** require invoice read scope on PDF route ([a35d7d0](https://github.com/sergsyp/nextcrm/commit/a35d7d0c0c7d12a58b4567bb3fa62fe1dc324508))
* **api:** require parent target write scope on target-contact create ([28912b4](https://github.com/sergsyp/nextcrm/commit/28912b43aed27a08243c066ed644d57c195fe817))
* **api:** require target write scope and contact linkage on per-target-contact enrich ([80f9ee4](https://github.com/sergsyp/nextcrm/commit/80f9ee4dadaff611cbd4fc578e2d7048e371ca76))
* **api:** require target write scope on enrich POST/DELETE (auto-fixes campaign re-export) ([18a0b56](https://github.com/sergsyp/nextcrm/commit/18a0b562a14b36f3b6137a18a856fb8f616f3414))
* **api:** require target write scope on per-target enrich (auto-fixes campaign re-export) ([85cfe72](https://github.com/sergsyp/nextcrm/commit/85cfe720fb2281eb73d74ec737d3c7037442b37f))
* **api:** scope reports/export by role; gate users-directory report ([571fbf3](https://github.com/sergsyp/nextcrm/commit/571fbf37caf71a7a2f66980cf28c6e1a710141e7))
* **api:** scoped contact PATCH closes BOLA/IDOR (GHSA-mg5f-m89f-4gmc) ([c80d3ec](https://github.com/sergsyp/nextcrm/commit/c80d3ec564ddb5f3bf38aec54ff5fb5aa3e7e90c))
* **api:** scoped target PATCH closes BOLA/IDOR (auto-fixes campaign re-export) ([cd0ed0a](https://github.com/sergsyp/nextcrm/commit/cd0ed0a4139398cf003505c44e9bc8a91a9def76))
* **auth:** align auth-client roles with renamed manager/user ([66e0e84](https://github.com/sergsyp/nextcrm/commit/66e0e8428556c9c75da28f601ef33d38cf94a674))
* **authz:** drop readonly tuple from accountUserScopeOR for Prisma compat ([39bcebe](https://github.com/sergsyp/nextcrm/commit/39bcebe70acfe17a391b1d0ad06178c7752b0a43))
* **authz:** guard directly-callable convertTarget action ([8b9f291](https://github.com/sergsyp/nextcrm/commit/8b9f291cdccdcf51c31562d8ceed072205845566))
* **authz:** include deletedAt:null in target read scope (crm_Targets has soft-delete) ([7a8fc2e](https://github.com/sergsyp/nextcrm/commit/7a8fc2e620c11e3abd9c3b1456703eced05eb61d))
* **authz:** replace is_admin checks with requireRole on admin invoice routes ([a54ed98](https://github.com/sergsyp/nextcrm/commit/a54ed9836deb11b7ba8714fc15a0248d36824ab3))
* **authz:** use lowercase prismadb.documents accessor ([a816361](https://github.com/sergsyp/nextcrm/commit/a816361a0029165294d1e201423a10fdc4e570d8))
* **authz:** use shared opportunity write-scope in setInactiveOpportunity ([30f9544](https://github.com/sergsyp/nextcrm/commit/30f95446bb825ded9105604a39c2c81b5ad86a58))
* **automation:** recover invalid tools and deduplicate email failures ([16ca4d0](https://github.com/sergsyp/nextcrm/commit/16ca4d0725141be690a610bfd9dfc66e8c666fe1))
* bound AI worker context and request time ([74744d4](https://github.com/sergsyp/nextcrm/commit/74744d4a8eda519a53e83935df93c6a084f82010))
* **calendar:** classify Google auth-revocation vs rate-limit/token errors ([51cdbec](https://github.com/sergsyp/nextcrm/commit/51cdbecfbc5dbdcfcc6d4475ac2b8a51886ad345))
* **calendar:** close unrelated-connection guard gap for disconnected accounts ([1c13839](https://github.com/sergsyp/nextcrm/commit/1c138396ed6b2132509b3ca3ce6e4c3c0cb7556b))
* **calendar:** exception-safe Calendly subscription + shared authz in admin settings ([5a127ab](https://github.com/sergsyp/nextcrm/commit/5a127ab6db964a5d125ecd0ac366ff91e22064a9))
* **calendar:** filter soft-deleted contacts/leads in matcher ([eba5ecd](https://github.com/sergsyp/nextcrm/commit/eba5ecd39595c6fbd32c4e0aec9d9071c423e3a2))
* **calendar:** harden outbound push against guest-list wipes, false revocations, and unauthorized writes ([03e3f60](https://github.com/sergsyp/nextcrm/commit/03e3f60e75aa6d577b2c76588c0c00b06d328d9c))
* **calendar:** harden outbound sync against duplicate inserts and reschedule 404s ([8717211](https://github.com/sergsyp/nextcrm/commit/8717211915d781579108e7ebe86c5512070ce35a))
* **calendar:** harden outbound sync emit against slow sends and fix write/emit ordering ([55845a1](https://github.com/sergsyp/nextcrm/commit/55845a1a7cf32d9c268775c2328f9c234c5e5be2))
* **calendar:** keep stored scopeLevel truthful, kill race duplicates, patch back-dated meetings ([e0729cc](https://github.com/sergsyp/nextcrm/commit/e0729cc3920aa3415f5bde05140d3c14ac0a9da7))
* **calendar:** log dropped Calendly webhook events missing uri/start_time ([290f23f](https://github.com/sergsyp/nextcrm/commit/290f23f26d21672d7f5d05c29722a4674e2166a0))
* **calendar:** OAuth state (CSRF) validation + narrowed error logging ([5978f82](https://github.com/sergsyp/nextcrm/commit/5978f82b072c2b1f2c7f06f542c6217a4a343695))
* **calendar:** record lastSyncError for upsert-loop failures in google sync ([fc3dedd](https://github.com/sergsyp/nextcrm/commit/fc3deddd447c20b387755bf9f0001222d1fd7e47))
* **calendar:** scope outbound mapping lookups/updates per-row, not per-activity ([6f5d41a](https://github.com/sergsyp/nextcrm/commit/6f5d41a389f4ae2c2f967bcfbf910932b9eb0c7b))
* **calendar:** stop notes edits on past meetings from emailing customers ([9eb4344](https://github.com/sergsyp/nextcrm/commit/9eb4344a52e5e1af8c0e1dfddc64f5d2eddaeb47))
* **calendar:** transactional upsert + P2002 race handling in calendar processor ([7b8c34a](https://github.com/sergsyp/nextcrm/commit/7b8c34a6a9f07b2713132df66d02df0735df87fe))
* **campaign-templates:** scope template reads/mutations by role and ownership ([417ae5a](https://github.com/sergsyp/nextcrm/commit/417ae5a8e7ad6049397af2a03997d27b81cc2bfe))
* **campaigns:** case-insensitive suppression matching and send-step last-gate guard ([f9df822](https://github.com/sergsyp/nextcrm/commit/f9df822c230c5da8b1c2dbb31a2d53301e0b9b4e))
* **campaigns:** keep unsubscribe confirmation on suppression write failure ([2bee7dc](https://github.com/sergsyp/nextcrm/commit/2bee7dc07fd15fc516592131476aa2fea561b77d))
* **campaigns:** narrow createCampaign result before using campaign.id ([1794a88](https://github.com/sergsyp/nextcrm/commit/1794a88ebde37b491a532865229c78175e5f65f4))
* **campaigns:** require auth + ownership on create/update/delete/pause ([6f2b02e](https://github.com/sergsyp/nextcrm/commit/6f2b02e1b35823c87a5a9d6a15e751bc90064c23))
* **campaigns:** require manager/admin role on schedule and send-now ([7361442](https://github.com/sergsyp/nextcrm/commit/7361442c5226030125ede66cb45ba6ea5c4a9aab))
* **campaigns:** scope campaign reads by role ([146d5b4](https://github.com/sergsyp/nextcrm/commit/146d5b4b224bd887dacb50e69b954ea7bdbb8795))
* **ci:** make migration chain replayable on a fresh database ([2c34ebb](https://github.com/sergsyp/nextcrm/commit/2c34ebbe203ffa620535eaf3437d2db5ed067d15))
* complete Russian localization for CRM workflows ([e2d0cad](https://github.com/sergsyp/nextcrm/commit/e2d0cada306d4aa5f994929c32f632231339e8bc))
* **crm-settings:** allow creating industry, opportunity type, and sales stage values ([dc111f0](https://github.com/sergsyp/nextcrm/commit/dc111f03541e3724e1483e832f39dbc0411b58fd))
* **crm:** align lead/contract table display schemas with DB nullability ([c1c8ef4](https://github.com/sergsyp/nextcrm/commit/c1c8ef42be008c4e4951efa336a5450b9fbaeb28))
* **crm:** align table display schemas with DB nullability (close_date, leads, contracts) ([37cfbef](https://github.com/sergsyp/nextcrm/commit/37cfbefd7df79c36bfebb04cc8aaa01581002a1b))
* **crm:** allow null close_date in opportunities table schema ([44cd972](https://github.com/sergsyp/nextcrm/commit/44cd972ba1869752e7da0294b5bb4544c7ccfd31))
* **crm:** blank-UUID + create-in-context UX; ci(e2e): pin inngest-cli ([2e75f1c](https://github.com/sergsyp/nextcrm/commit/2e75f1cd11462a30b81a3fbd42c240597605fb2d))
* **crm:** drop empty currency on opportunity update; e2e round 2 ([bbac5ea](https://github.com/sergsyp/nextcrm/commit/bbac5ea7a9e57b66346101f678806a4cfc8766f1))
* **crm:** exclude cancelled activities from the Phase 2 kill-clock query ([a2c8a2d](https://github.com/sergsyp/nextcrm/commit/a2c8a2dfdb2d01531e36116b4a37f75d6c740bb4))
* **crm:** final-review fixes — protect re-engaged targets and completed renewals ([f2a7434](https://github.com/sergsyp/nextcrm/commit/f2a743412d657a8ac99782595790ab9e8b37c937))
* **crm:** make target-to-deal conversion idempotent and honor error contract ([a27cf00](https://github.com/sergsyp/nextcrm/commit/a27cf00c1740c8f69cb0474dd1f365d1ff28670c))
* **crm:** normalize blank UUID fields in createAccount ([6123855](https://github.com/sergsyp/nextcrm/commit/612385540a259868ecfe1ea81e02d7ea6da0960c))
* **crm:** normalize blank UUID inputs and auto-fill account/assignee on create ([a5b0a78](https://github.com/sergsyp/nextcrm/commit/a5b0a782f327aadb21c7ccc8faeae63e1de818fa))
* **crm:** require account read scope on getAccountById ([edb9b9b](https://github.com/sergsyp/nextcrm/commit/edb9b9b821b10cc5271560b73caf8efaba02c59c))
* **crm:** require entity-scoped read access on activity feed ([568a7cc](https://github.com/sergsyp/nextcrm/commit/568a7cc8c56e0eb10f97442bb43ea3206978a4d6))
* **crm:** scope account list by user/manager/admin role ([a9f9a6f](https://github.com/sergsyp/nextcrm/commit/a9f9a6fa3755e561678361d91af6bae8e239fa2e))
* **crm:** scope account search by user/manager/admin role ([3fd6673](https://github.com/sergsyp/nextcrm/commit/3fd6673879f88ffff8c50dd5801d02b141cecc89))
* **crm:** scope audit-log-by-entity and normalize audit-log-admin to canonical helper ([ea45503](https://github.com/sergsyp/nextcrm/commit/ea45503d576a6fc3181f742adaff58e58b735936))
* **crm:** scope contact reads by role and linked-account/opportunity access ([be7e186](https://github.com/sergsyp/nextcrm/commit/be7e186236b2eef48b0915428cc75eca1c6f0667))
* **crm:** scope contract reads by role and linked-account access ([9b39448](https://github.com/sergsyp/nextcrm/commit/9b39448178c3d6ed241aadf60894ea1fd9479a9f))
* **crm:** scope lead reads by role and linked-account access ([b5d088b](https://github.com/sergsyp/nextcrm/commit/b5d088bbb63d69e5bc79fd62c32f37edf46eabbc))
* **crm:** scope opportunity reads by role; cache key respects user scope ([16c64fb](https://github.com/sergsyp/nextcrm/commit/16c64fbfb063ae0ea41678fa059e74357e296561))
* **crm:** scope pgvector similarity results by user/manager/admin ([a1fb3a8](https://github.com/sergsyp/nextcrm/commit/a1fb3a84a6aab9913929d61d1b5b1bc54420e276))
* **crm:** scope remaining opportunity read actions (by-account, by-contact, user-opps) ([e8bcfc9](https://github.com/sergsyp/nextcrm/commit/e8bcfc91192d6929c046d91456393c1b82f0d6b7))
* **crm:** scope target and target-list reads by role ([9e326eb](https://github.com/sergsyp/nextcrm/commit/9e326ebf35c6596af27779a3faa3b366856f9101))
* **crm:** serialize Prisma Decimals in opportunities/contracts fetches (RSC boundary error) ([48a6bb0](https://github.com/sergsyp/nextcrm/commit/48a6bb0550d9fafc174c55911e5aff7215b794e3))
* **crm:** serialize Prisma Decimals in opportunities/contracts list fetches ([ffba94a](https://github.com/sergsyp/nextcrm/commit/ffba94aebec29c2bdad101a6d6d6875073cc3583))
* **crm:** wire CRM task documents to correct junction table + cleanup ([d4c503c](https://github.com/sergsyp/nextcrm/commit/d4c503c598a6905b6be826d311beb3fac2218bfa))
* **db-guard:** block empty/unresolvable host instead of passing it ([521137f](https://github.com/sergsyp/nextcrm/commit/521137f93129f3af146b4ee2fc7faf10c6a4390d))
* **db-guard:** close query-string [@localhost](https://github.com/localhost) bypass, fix bracketed IPv6 ([8909bc3](https://github.com/sergsyp/nextcrm/commit/8909bc3f631cc007bfdd21e76c6f94a35a9aa8cf))
* **deploy:** pin pnpm 11 via packageManager so nixpacks doesn't build with pnpm 9 ([aedeab3](https://github.com/sergsyp/nextcrm/commit/aedeab33fd90f10f22e3c842daf8d59819b553b4))
* **deploy:** use current corepack in nixpacks and migrate to pnpm 11 allowBuilds ([82ccda4](https://github.com/sergsyp/nextcrm/commit/82ccda4b2b577cb46cf9f911fbac7d34ee26ff7c))
* **deps:** patch 2 Dependabot vulnerabilities ([0e2746c](https://github.com/sergsyp/nextcrm/commit/0e2746c2dd504e7e6a8c0d5e86ef9186e5b3c8f7))
* **deps:** patch Dependabot advisories via pnpm overrides ([42eba8e](https://github.com/sergsyp/nextcrm/commit/42eba8e1b83cbe87b7f3a21f5d7df096f051e3d1))
* **deps:** patch Dependabot security advisories ([6002241](https://github.com/sergsyp/nextcrm/commit/60022410b56eab12abd4b10615e1602ade8c159f))
* **deps:** patch Dependabot security advisories via pnpm overrides ([22b2ecf](https://github.com/sergsyp/nextcrm/commit/22b2ecf2f09528a3219e740df36b7399ad967298))
* **deps:** pin kysely 0.28 — restore main deployability (better-auth 1.6.13 adapter breakage) ([b7392ac](https://github.com/sergsyp/nextcrm/commit/b7392acc5d0e42ff0465e0db0b9a20c14deafbfd))
* **deps:** pin kysely to 0.28 line — better-auth 1.6.13 adapter incompatible with kysely 0.29 ([284a305](https://github.com/sergsyp/nextcrm/commit/284a30519f12cc95a53bb56dbc43ac70f8629478))
* **deps:** resolve all 65 Dependabot security alerts ([29efcd7](https://github.com/sergsyp/nextcrm/commit/29efcd79c6386f1510563c124bcf4a99e5c42d7d))
* **deps:** resolve all 65 Dependabot security alerts (one PR) ([2647733](https://github.com/sergsyp/nextcrm/commit/2647733eb536d807adef070b719a95c0f8d7870f))
* **deps:** resolve all 65 Dependabot security alerts via pnpm overrides ([3412d9a](https://github.com/sergsyp/nextcrm/commit/3412d9ac05963f58c6f5708f863ad45b349e2039))
* **dev:** bind local Postgres to loopback and bound db:wait retries ([989e2ed](https://github.com/sergsyp/nextcrm/commit/989e2ed9ccdf8b621147db962121b9b5a18721b0))
* **dev:** guard db scripts against remote DB and correct local Postgres docs ([3482cd0](https://github.com/sergsyp/nextcrm/commit/3482cd0936de273d6ce24cf28018ac8ff965cd7b))
* **docker:** make production image build reproducibly ([2a31dd0](https://github.com/sergsyp/nextcrm/commit/2a31dd021aaf2676c30cc12c49c8ee1ec5a41e9b))
* **documents:** enable mobile preview scrolling ([7d7684a](https://github.com/sergsyp/nextcrm/commit/7d7684a188f781abe2e8e027333c1957add8c306))
* **documents:** filter bulk document operations by user scope (fail-closed) ([61132fe](https://github.com/sergsyp/nextcrm/commit/61132fee767cffbd9b4d81d9dc7b052bb969d3c0))
* **documents:** fit text preview on mobile ([1c8600e](https://github.com/sergsyp/nextcrm/commit/1c8600ed5a2420ce6b3ac0e2f239f8b6a827d1e5))
* **documents:** load task content for preview ([d8b99bc](https://github.com/sergsyp/nextcrm/commit/d8b99bc51110525991d23f20d8083bae4cef38fc))
* **documents:** preview and download task text documents ([b6af446](https://github.com/sergsyp/nextcrm/commit/b6af446fdf9ba6a453f28641f64b9c4d313b40c0))
* **documents:** preview stored text regardless of file URL ([6311ff7](https://github.com/sergsyp/nextcrm/commit/6311ff73e4692a7fc0ac74fc94186460cc8b776e))
* **documents:** render and download internal markdown ([74d7aa2](https://github.com/sergsyp/nextcrm/commit/74d7aa23dbbf8416fbdaca794871c6a7371bd40a))
* **documents:** require ownership/account scope on document mutations ([5bb9035](https://github.com/sergsyp/nextcrm/commit/5bb9035052326065cab5d5c56c57d959d60fce07))
* **documents:** scope document reads by role and linked-entity access ([220cf23](https://github.com/sergsyp/nextcrm/commit/220cf231c5ddcda9905e556f92aefa4268d6015b))
* **email:** preserve synced bodies and CRM traceability ([3ab3255](https://github.com/sergsyp/nextcrm/commit/3ab32550b7ff407068619d9eb201d22596df03fc))
* **i18n:** type industry translation lookup ([25020be](https://github.com/sergsyp/nextcrm/commit/25020be3efbbbe6e03dd35b6900966c15caed668))
* **invoices:** add PROFORMA to Zod invoice type enum ([18d6e40](https://github.com/sergsyp/nextcrm/commit/18d6e40281ab8fb726f21c6c4b99ddb92ea79ff6))
* **invoices:** add supplier company details, PDF regeneration, admin route guard ([31e2b29](https://github.com/sergsyp/nextcrm/commit/31e2b29c0d99d5a86429eeb5b03de38c45586cd2))
* **invoices:** consolidate Invoice_Currencies into shared Currency table ([43f3814](https://github.com/sergsyp/nextcrm/commit/43f3814a57973d18a7d687ee153a7b108231f68b))
* **invoices:** consolidate Invoice_Currencies into shared Currency table ([2c6820d](https://github.com/sergsyp/nextcrm/commit/2c6820d65e440906472f498b490f7c9fbdd73ea3))
* **invoices:** fix Set type annotation in permissions for strict tsc ([1132616](https://github.com/sergsyp/nextcrm/commit/1132616272afd08368884862a2ef436bf24dfb12))
* **invoices:** hydration mismatches, decimal serialization, server action refactor ([75368f4](https://github.com/sergsyp/nextcrm/commit/75368f409bf61792ca0997492448b30ab4a3cd36))
* **invoices:** redirect to /invoices after creating new invoice ([2dd2d5e](https://github.com/sergsyp/nextcrm/commit/2dd2d5ecbee40f515a1f5d77153acffcea519600))
* **invoices:** redirect to invoice detail page after create/edit ([d58c35d](https://github.com/sergsyp/nextcrm/commit/d58c35db10e4ab03d88aec9fa0be7297d915db58))
* **invoices:** remove unused imports and prefix unused params ([b3e4ccc](https://github.com/sergsyp/nextcrm/commit/b3e4cccdabf580dedd4329afd3d2133eba38a436))
* **invoices:** remove unused React import from PDF template ([b851ece](https://github.com/sergsyp/nextcrm/commit/b851ece3b534acfbc4d628ad6fb10227679ee7c1))
* **invoices:** replace Account select with searchable combobox ([08e9b3d](https://github.com/sergsyp/nextcrm/commit/08e9b3d61f87113e6254fae2f48da15f6c2b42b5))
* **invoices:** require account read scope on get-invoices-by-accountId ([c8cbf66](https://github.com/sergsyp/nextcrm/commit/c8cbf669e34e651eb65e9799f25491480eef52f2))
* **invoices:** require account write scope on create and on accountId reassignment ([f8282e5](https://github.com/sergsyp/nextcrm/commit/f8282e5ec64f7f469502173d1d28af34b81f7bae))
* **invoices:** require read scope on source and write scope on accountId for duplicateInvoice ([eb792a7](https://github.com/sergsyp/nextcrm/commit/eb792a76dd05dfba7bf9db855e27f6d293db5ce9))
* **invoices:** review fixes — balanceDue, FX outside tx, permissions, search column, email template ([dde9dfa](https://github.com/sergsyp/nextcrm/commit/dde9dfaba15274c910329a71ad299585407c47f8))
* **invoices:** supplier company details, PDF regeneration, admin route guard ([4c45b8e](https://github.com/sergsyp/nextcrm/commit/4c45b8e48ca60741c39d54ff2744a93242e1fabe))
* **mcp:** keep empty web searches recoverable ([0330e80](https://github.com/sergsyp/nextcrm/commit/0330e800875fab5131e89401117a12d68d677c54))
* **mcp:** role-aware read scoping and account/contact linking in CRM tools ([3a89d55](https://github.com/sergsyp/nextcrm/commit/3a89d5555277c1c5a1fbb83826f91c6a9ee2ce12))
* **mcp:** role-aware read scoping, FK linking, and user lookup for CRM tools ([4575e9d](https://github.com/sergsyp/nextcrm/commit/4575e9d7dec10a9f689a910ded518a0797cfe2f3))
* **mcp:** serialize bigint response values ([13aad86](https://github.com/sergsyp/nextcrm/commit/13aad86329fc1fbf08041e5d9b1c5ce7bce02cf6))
* **mcp:** set basePath so /api/mcp/{mcp,sse} actually route ([16fb5be](https://github.com/sergsyp/nextcrm/commit/16fb5be137fb54b5de324f659dd8b48881004aad))
* **mcp:** set basePath so /api/mcp/{mcp,sse} actually route ([3c36be2](https://github.com/sergsyp/nextcrm/commit/3c36be22658d27092606e32dea3d083fcc0b1bfd))
* **migration:** scrub orphan creator FK refs before adding new FK constraint ([7fa5196](https://github.com/sergsyp/nextcrm/commit/7fa5196b04d594386ce17bd23049207a556e581e))
* preserve campaign SMTP failure state ([195d673](https://github.com/sergsyp/nextcrm/commit/195d673faffb7315c356153936ed17159742d95c))
* preserve email bodies and CRM traceability ([1c2356c](https://github.com/sergsyp/nextcrm/commit/1c2356c7e7704228431f5184de7150a4d02c2405))
* **prisma:** add missing crm_Target_Contact migration ([7d76537](https://github.com/sergsyp/nextcrm/commit/7d76537f9ae994430fd782b6c7a789eb4dac69a8))
* **prisma:** add missing migration for crm_Target_Contact table ([792b8c3](https://github.com/sergsyp/nextcrm/commit/792b8c3ec24efeea963afdcbc71d4b2bf003bc72))
* **products:** require authentication on product read actions ([b2a860f](https://github.com/sergsyp/nextcrm/commit/b2a860fcbff5cd84bbd73faf574c1f3079653ce2))
* **products:** require manager/admin role on product mutations ([61ed918](https://github.com/sergsyp/nextcrm/commit/61ed918e65629661f9818ca2a4dcf6bc3f46a4cb))
* **projects:** require board write/read scope on board mutations ([522ca13](https://github.com/sergsyp/nextcrm/commit/522ca1323f45b38f5c78fdd64116d5c6c8f07206))
* **projects:** require parent board write scope on section mutations ([65e208f](https://github.com/sergsyp/nextcrm/commit/65e208fcff948eca80e3380fb599dc585f63b0e7))
* **projects:** scope project read actions by board access ([5ddaa97](https://github.com/sergsyp/nextcrm/commit/5ddaa976f853b88b526c129e0787939aa4567a9b))
* **projects:** scope task mutations (board strict + assignee soft) ([27f0cf8](https://github.com/sergsyp/nextcrm/commit/27f0cf8dfd7999599397d4f65a7f9d082900c848))
* **reports:** gate users-directory report behind manager/admin ([20aeeaf](https://github.com/sergsyp/nextcrm/commit/20aeeafec24b3d6f02ad3f69e1d0d2d68c88f4f8))
* **reports:** scope config and schedule reads/mutations by role and ownership ([932de36](https://github.com/sergsyp/nextcrm/commit/932de36cd3dd84c20fae20d49f72badd76a970e0))
* **reports:** scope dashboard tasks count and unified search by role ([d17a880](https://github.com/sergsyp/nextcrm/commit/d17a880eb6b8ac06097756d6006fcf11b44b1138))
* **reports:** scope scheduled-report data by schedule owner role ([7f7c7b6](https://github.com/sergsyp/nextcrm/commit/7f7c7b63f1cf6fd550454b3040981f1bbef13b5d))
* **security:** admin server action lockdown (Phase C) ([5a555fe](https://github.com/sergsyp/nextcrm/commit/5a555febe929bb3d477704914756737a04f3d3fd))
* **security:** authorize Resend key action, harden IMAP/SMTP connect surface ([648160f](https://github.com/sergsyp/nextcrm/commit/648160f0dfdaa235d45ec8b3806f4552277244f3))
* **security:** authz cleanup — drop is_admin, role enum (Phase F) ([c22bf83](https://github.com/sergsyp/nextcrm/commit/c22bf837e83b10487641fcfc458629fa0fedf5d6))
* **security:** close enrichment BOLA/IDOR (Phase B1) ([726be4c](https://github.com/sergsyp/nextcrm/commit/726be4cb48c60620a15c3a3a850e8bde379a6e54))
* **security:** close GHSA-mg5f-m89f-4gmc + permission-driven authz foundation ([e6987aa](https://github.com/sergsyp/nextcrm/commit/e6987aa049dc6816a25c45436556960893c9c15d))
* **security:** close invoice IDOR (Phase B2) ([88d488b](https://github.com/sergsyp/nextcrm/commit/88d488b939057f4769d22f6ce00442738d73792b))
* **security:** enforce manager/admin RBAC in MCP product tools (GHSA-wv63-cq38-qg58) ([02e7a22](https://github.com/sergsyp/nextcrm/commit/02e7a226e1363a060013cc16bb4d26d4c190bc27))
* **security:** enforce manager/admin RBAC in MCP product tools (GHSA-wv63-cq38-qg58) ([1c41d58](https://github.com/sergsyp/nextcrm/commit/1c41d5832629f50e658fb64a884c98e846830549))
* **security:** enforce object-level authz in MCP campaign tools (GHSA-c9vg-c532-ppqx) ([d219b7b](https://github.com/sergsyp/nextcrm/commit/d219b7b47291e52cd200fba193f4da68c6dde75a))
* **security:** enforce object-level authz in MCP campaign tools (GHSA-c9vg-c532-ppqx) ([88258b1](https://github.com/sergsyp/nextcrm/commit/88258b1cce63f42e9399b1ce9575a72dc89b72c5))
* **security:** scope campaigns + templates (Phase E2) ([99effa9](https://github.com/sergsyp/nextcrm/commit/99effa90d2154a930933b58bf64105fd70e0f52a))
* **security:** scope CRM account reads by role (Phase D1) ([cbc3a30](https://github.com/sergsyp/nextcrm/commit/cbc3a30a9b16ef3bd3e85ea7cc5bec234eba17f6))
* **security:** scope CRM accounts list by user authz read scope ([08c0ec7](https://github.com/sergsyp/nextcrm/commit/08c0ec7c521d44c02e7978aaf1744d9229e049df))
* **security:** scope CRM accounts list by user authz read scope ([8e86e03](https://github.com/sergsyp/nextcrm/commit/8e86e03894e4cb4b9d9c5d2265a915fd9ce775bb))
* **security:** scope CRM lead/contact/opportunity/contract reads by role (Phase D2) ([d795b00](https://github.com/sergsyp/nextcrm/commit/d795b00f6558777f3019a830069561fccb4de4f5))
* **security:** scope documents + bulk ops (Phase E3) ([12ac3df](https://github.com/sergsyp/nextcrm/commit/12ac3df7218d9512a5b6f0cf33cc750cc9ffe4d1))
* **security:** scope products + account-products + invoice list (Phase E1) ([4ecfc56](https://github.com/sergsyp/nextcrm/commit/4ecfc565c7b40c2b038f418971fc292a2c596663))
* **security:** scope projects (boards/sections/tasks) (Phase E4) ([bc2a72a](https://github.com/sergsyp/nextcrm/commit/bc2a72a23c6ae4895c7c9cdf74f45ccaeb915bf2))
* **security:** scope reports + dashboard + unified search by role (Phase B3) ([477dcf6](https://github.com/sergsyp/nextcrm/commit/477dcf6b31db740bfb3e875f972c63ba2cd19bba))
* **security:** scope targets, activities, audit log, similarity (Phase D3) ([07a03f9](https://github.com/sergsyp/nextcrm/commit/07a03f9f23b09b29994c1ccacd16fb3e520308c6))
* send campaigns through configured SMTP ([90379cc](https://github.com/sergsyp/nextcrm/commit/90379cc99047edbb724ba9cb19b8ff65064fbc7f))
* send campaigns through configured SMTP ([0230e29](https://github.com/sergsyp/nextcrm/commit/0230e29fbf2c4352e333640365b4f8d47d3443c4))
* **telegram:** preserve approval on callback ack failure ([83798ce](https://github.com/sergsyp/nextcrm/commit/83798ced88b61703a06849cd1a8264a8df9ec00d))
* **telegram:** preserve secret file env in Next bundle ([35bed46](https://github.com/sergsyp/nextcrm/commit/35bed465dd91329b207f79f597e5a84135669036))
* **telegram:** relay blocked API egress securely ([ebbb4c4](https://github.com/sergsyp/nextcrm/commit/ebbb4c4206aa20dbf772060b91ab614f8e75deac))
* **telegram:** serialize CRM message identifiers safely ([de2634e](https://github.com/sergsyp/nextcrm/commit/de2634e1bd0d594515c71a6db9ce22980d1ddbb8))
* **telegram:** support Docker secret files ([ecea2ee](https://github.com/sergsyp/nextcrm/commit/ecea2ee0743541680c42ca495d055c35f3136af5))
* **telegram:** type callback acknowledgements ([19168f9](https://github.com/sergsyp/nextcrm/commit/19168f984cff9c5a921d6cf47a9cb4fd0b69b9d3))
* **tests:** merge duplicate prismadb.documents mock keys after lowercase fix ([3446bc9](https://github.com/sergsyp/nextcrm/commit/3446bc96e08d28457dee09d014297ef42370e91a))
* type mailbox delegation filters ([53309a6](https://github.com/sergsyp/nextcrm/commit/53309a6f71f854126d2caa691593edacd0c347a9))
* use sales mailbox in AI team guidance ([9df2189](https://github.com/sergsyp/nextcrm/commit/9df21890abf7551de0f84d32ec1992b3d5df70a3))


### Changed

* **admin:** normalize delete-user and invite-user to canonical requireRole helper ([4804a1d](https://github.com/sergsyp/nextcrm/commit/4804a1d496d0130b49a40c4b3e4408b4aba9fe45))
* **admin:** normalize invoice-settings to canonical requireRole helper ([9cf5136](https://github.com/sergsyp/nextcrm/commit/9cf5136742667d016fc7bd2381a9bbf0dacbe9e2))
* **admin:** normalize send-mail-to-all to canonical requireRole helper ([7dfafbe](https://github.com/sergsyp/nextcrm/commit/7dfafbe4341a293a6948b67734fa208cb214cebb))
* **admin:** normalize system-api-keys actions to canonical requireRole helper ([c2e304e](https://github.com/sergsyp/nextcrm/commit/c2e304e69766dc9950768903398e69e04a605f1c))
* **admin:** stop writing is_admin column from user actions ([4c890a4](https://github.com/sergsyp/nextcrm/commit/4c890a473d44b77161dee7213a54b9309ecf2166))
* **auth:** rename Better Auth roles member-&gt;manager, viewer-&gt;user ([39180b4](https://github.com/sergsyp/nextcrm/commit/39180b4c6add371d7f5f329404e85c28098c6bbd))
* **auth:** switch admin plugin to canonical user/manager/admin roles ([37c6edb](https://github.com/sergsyp/nextcrm/commit/37c6edba66180de2db61a0df9604c59cdbf73546))
* **authz:** gate admin layout on canonical role, drop is_admin check ([9a09991](https://github.com/sergsyp/nextcrm/commit/9a099912a3da24e175c5a205868c67ac8bd6364a))
* **crm:** minimal validation on account create/edit forms ([05b698e](https://github.com/sergsyp/nextcrm/commit/05b698e29f2eb2397fcd1c01dba60248d00ac7cf))
* **crm:** relax NewAccountForm validation to require only name ([d23017a](https://github.com/sergsyp/nextcrm/commit/d23017add4802ed9e71f31ce6e6091fc04eee000))
* **crm:** relax UpdateAccountForm validation to require only name ([0348bad](https://github.com/sergsyp/nextcrm/commit/0348badc787d8e58c3fe139c092d6ed94b9be6c7))
* **invoices:** pass role-aware UserCtx to permission helpers ([d54b8e5](https://github.com/sergsyp/nextcrm/commit/d54b8e5094f772ace9ec84b758dcf81db1a72176))
* **invoices:** replace all API routes with direct server actions ([2df915e](https://github.com/sergsyp/nextcrm/commit/2df915eb4b6f1e1fb0b4b0c762d068c3fac2e905))
* **invoices:** require admin role on delete-payment via canonical helper ([75d0806](https://github.com/sergsyp/nextcrm/commit/75d080679fba1a42e0ed04ce91c389ed10a757da))
* **invoices:** role-aware permissions (user/manager/admin); add canReadInvoice ([eddb0be](https://github.com/sergsyp/nextcrm/commit/eddb0bedf933aa22840beb0d44ee451da8c92292))
* **schema:** consolidate dual creator columns on contacts and opportunities (Phase F.1) ([b4677fb](https://github.com/sergsyp/nextcrm/commit/b4677fb72d2df7546a2c5f2c3606cf77c2459b86))
* **schema:** consolidate dual creator columns on contacts and opportunities (Phase F.1) ([b6ba238](https://github.com/sergsyp/nextcrm/commit/b6ba238108ae6378625123fdfa7376b0150ba569))
* **schema:** drop legacy is_admin and is_account_admin columns ([9356e95](https://github.com/sergsyp/nextcrm/commit/9356e95c1f9a17e761527709eaaf661b39dfbde4))
